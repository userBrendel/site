        ...
        <div className="flex flex-col justify-between">
          <div>
            ...
            <div className="grid grid-cols-2 text-lg mb-6 max-w-xs gap-3">
              <h1 className="border rounded-3xl flex items-center justify-center h-10 px-4">
                Her
              </h1>
              <h1 className="border rounded-3xl flex items-center justify-center h-10 px-4">
                EDP
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              Experience the allure of our signature fragrance, blending floral
              elegance with warm, woody notes. Perfect for evening wear or a
              special occasion.
            </p>
          </div>
          ...
          <div className="flex items-center mt-4 text-2xl">
            <FilledButton size="lg">Add To Bag</FilledButton>
